...
class Maze(tk.Tk, object):
    def __init__(self):
        ...
        self.geometry('{0}x{1}'.format(WIDTH * UNIT,
                                       HEIGHT * UNIT))  # Tkinter 的几何形状
        self.build_maze()
    ...
    def build_maze(self):
        ...
        self.canvas = tk.Canvas(
            self, bg='white', width=WIDTH * UNIT, height=HEIGHT * UNIT)
        ...
        self.treasure = self.canvas.create_rectangle(
            treasure_center[0] - 15,
            treasure_center[1] - 15,
            treasure_center[0] + 15,
            treasure_center[1] + 15,
            fill='green')
